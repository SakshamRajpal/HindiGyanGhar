//this will be used multiple times so we will import this 
//to features.jsx so that duplacacy does not occur
...
export const features = [
    {
      ...
      title: 'Learn Hindi the Smart Way',
      text: "Why memorize blindly when you can understand deeply? With our smart tools and engaging content, learning Hindi feels natural, fun, and effective — like chatting with a friend, not studying for an exam.",
      button: {
    ...
    },
    {
      ...
      title: 'हिंदी सीखिए, आसान और मज़ेदार तरीके से',
      text: 'रटने की ज़रूरत नहीं — समझिए और बोलिए आत्मविश्वास के साथ।हमारे स्मार्ट टूल्स और इंटरेक्टिव अभ्यासों से हिंदी सीखना बन जाए एक रोमांचक अनुभव।',
      button: {
  ...
  export const details = [
    ...
    },
    {
      ...
      title: 'Bilingual UI (Hinglish Mode)',
    },
    {
      id: '2',
      icon: '/images/detail-3.png',
      title: 'Personal Vocab List',
    },
    {
      id: '3',
  ...
  export const faq = [
    ...
    },
    {
      ...
      answer:
        '"How are you?" is "आप कैसे हैं?" (Aap kaise hain?)',
    },
    {
      id: '2',
      question: 'What is the Hindi word for "Water"?',
      answer:
        'Water in Hindi is "पानी" (Paani)',
    },
    {
      id: '3',
      question: 'How do you say "My name is John" in Hindi?',
      answer:
        '"My name is John" is "मेरा नाम जॉन है" (Mera naam John hai)',
    },
    {
      id: '4',
      question: 'What is the Hindi word for "Mother"?',
      answer:
        'Mother is "माँ" (Maa) in Hindi.',
    },
    {
      id: '5',
      question: 'How do you say "I am hungry" in Hindi?',
      answer:
        '"I am hungry" is "मुझे भूख लगी है" (Mujhe bhookh lagi hai).',
    },
    {
      id: '6',
      question: 'What does "धन्यवाद" mean in English?',
      answer:
        '"धन्यवाद" means "Thank you" in English.',
    },
    {
      id: '7',
      question: 'How do you say "I love India" in Hindi?',
      answer:
        'I love India" is "मुझे भारत से प्यार है" (Mujhe Bharat se pyaar hai).',
    },
    {
      id: '8',
      question: 'What is "School" in Hindi?',
      answer:
        'School in Hindi is "विद्यालय" (Vidyalaya) or simply "स्कूल" (School)',
    },
    {
      id: '9',
      question: 'How do you say "Good night" in Hindi?',
      answer:
        'Good night" is "शुभ रात्रि" (Shubh Raatri) in Hindi',
    },
  ];
